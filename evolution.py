...
class EVOlution(loader.Module):
    ...
    strings = {
        ...
        'delay_boss' : 'Задержка между отправкой атакой',
        ...
        'petroleum' : 'Добывать нефть автоматически?\nПосле включения отправьте в лс бота "Качать"\nПосле этого больше не пишите качать нигде, иначе будут создаваться новые циклы',
