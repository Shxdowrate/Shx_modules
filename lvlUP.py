...
class lvlUP(loader.Module):
    ...
    async def watcher_integration(self, message):
        ...
        command_2 = prefix + ' integration'
        command_3 = prefix + 'Integration'
        command_4 = prefix + ' Integration'
        m = message.raw_text
        if  m == command or m == command_2 or m == command_3 or m == command_4:
